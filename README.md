...
|[Финальный проект 1.1. Анализ поведения пользователей мобильного приложения](https://github.com/demoniksamael/Practikum_projects/tree/main/Финальный%20проект/Анализ%20поведения%20пользователей%20мобильного%20приложения)| Изучение метрик DAU, WAU, hасчет Retention Rate, расчет конверсии, проверка статистических гипотез | *Pandas, Seaborn, Matplotlib, Plotly, Statsmodels,NumPy*, когортный анализ, событийная аналитика|
